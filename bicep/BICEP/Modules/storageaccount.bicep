...
var STORAGE_ACCOUNT_VMBACKUPS_NAME = 'strvmbackups${uniqueString(resourceGroup().id)}'
...
//Deploy the Storage Account for VM Backups
resource storageaccountvmbackups 'Microsoft.Storage/storageAccounts@2022-09-01' = {
  name: STORAGE_ACCOUNT_VMBACKUPS_NAME
  location: location
  tags: TAG_VALUE
  kind: 'StorageV2'
  sku: {
...
output OUTPUT_STORAGE_ACCOUNT_VMBACKUPS_ID string = storageaccountvmbackups.id
output OUTPUT_STORAGE_ACCOUNT_VMBACKUPS_NAME string = storageaccountvmbackups.name
